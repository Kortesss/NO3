/********************************************************************************
** Form generated from reading UI file 'grDerivative.ui'
**
...
#ifndef UI_GRDERIVATIVE_H
#define UI_GRDERIVATIVE_H
...
" }"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/img/img/heart-monitor.png"), QSize(), QIcon::Normal, QIcon::Off);
